...
copyright = '2012-2017, YourLabs'  # NGO
...
latex_documents = [
    (master_doc, 'django-autocomplete-light.tex', 'django-autocomplete-light Documentation',
     'James Pic \\& contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'django-autocomplete-light', 'django-autocomplete-light Documentation',
     [author], 1)
]
